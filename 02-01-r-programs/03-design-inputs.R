...
sp         = read.csv(file="sp.settings.csv");
...
rownames(y) <- NULL
colnames(y) <- c("pi0","pi1","sd1","sd2","rho","change","eqm1","eqm2","trad.n1","trad.n2","sp1","sp2","iFrac1","iFrac2","n1","n2","seed");
write.csv(y,file="simulation-design-inputs.csv",row.names=F);